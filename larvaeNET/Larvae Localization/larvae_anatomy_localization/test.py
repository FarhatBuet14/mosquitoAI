...
test_dir = 'local/Specimen 5__male' # "../../../data/working/img/larvae_localization_test"
...
for i in tqdm(range(0, len(test_image_paths))):
    ...
    file_path = test_dir + "/" + clothing_image
    ...
    write_res = cv2.imwrite(f'local_out/{file_name}', result)
