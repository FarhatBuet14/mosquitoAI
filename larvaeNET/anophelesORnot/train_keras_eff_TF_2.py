...
# assert x_test.shape == (len(x_test), 224, 224, 3)
...
# headModel = Dense(64, activation="relu", kernel_initializer="glorot_uniform")(headModel_3)
# headModel = BatchNormalization()(headModel)
# headModel_4 = Dropout(0.3)(headModel)
# headModel = Concatenate()([headModel_2, headModel_3, headModel_4])
# headModel = Dense(num_class, activation="softmax")(headModel)

# model = Model(inputs=baseModel.input, outputs=headModel)

# Load model
model = load_model("logs/efficientNetB0/8_1e-3_adam_sparseLoss_3layersAdd_TF_1/best/model00000537.h5")
